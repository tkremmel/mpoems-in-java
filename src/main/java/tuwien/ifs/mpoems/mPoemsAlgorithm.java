	...
	public SolutionSet start() throws Exception{
		try{
			...
			do {
	        	...
	        	Solution prototypeClone = prototype.clone();
	        	...
	        	ASPopulation newASPop = mP.runMOEA(prototype,prototypeClone,base);
	        	SolutionSet newSolutions = prototypeClone.applyActions(newASPop);
	        	...
	        	base.mergeSolutionSets(newSolutions,prototypeClone);
