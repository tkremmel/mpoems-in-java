...
public class mPOEMS{
	 ...
	 * executes the MOEA
	 */
	protected ASPopulation runMOEA(Solution prototype, SolutionSet base) throws Exception {
		...
		oldASPop.evaluate(prototype,base);
		
		int i = 1;
        do {
        	newASPop = oldASPop.runEvolutionaryCycle();
        	newASPop.calculateObjectives(prototype);
